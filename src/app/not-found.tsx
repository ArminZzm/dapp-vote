...
const NotFound = () => {
  return (
    <div className="min-h-[450px] flex justify-center items-center global-not-found">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-100">
        <div className="max-w-md flex flex-col gap-8">
          ...
          <Link
            href="/"
            className="px-4 inline py-2 text-sm text-center font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700"
          >
            back to homepage
          </Link>
        </div>
